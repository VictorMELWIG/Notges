...
<body>
    <div class="navbar">
        ...
        <?php if (estProfesseur()): ?>
            ...
            <a href="index.php?page=gererLesDevoirs">Gérer les devoirs</a>
        <?php endif; ?>

        <?php if (estGestionnaire()): ?>
            <a href="index.php?page=gererlesProfesseurs">Gérer les professeurs</a>
            <a href="index.php?page=affectationProfesseurs">Affectation profs / matières</a>
        <?php endif; ?>
        ...
        if (isset($_GET['page'])) {
            ...
            switch ($page) {
                ...
                case 'gererlesProfesseurs':
                    ...
                    break;
                case 'affectationProfesseurs':
                    include 'affectationProfesseurs.php';
                    break;
                case 'eleve_vue_liste':
                    include 'eleve_vue_liste.php';
                    break;
                case 'gererLesDevoirs':
                    include 'gererLesDevoirs.php';
                    break;
                case 'gererLesNotes':
                    include 'gererLesNotes.php';
                    break;
                case 'deconnexion':
